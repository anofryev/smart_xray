        ...
        for imaging_study in imaging_studies: # Перебираем все найденные ImagingStudies
            ...
            try: # ищем пациента
                ...
                if patient_related.given:
                    model_patient.given = patient_related.humanname.given
                if patient_related.family:
                    model_patient.family = patient_related.humanname.family
            ...
            try: # ищем специалиста
                ...
                if practitioner_related.given:
                    model_practitioner.given = practitioner_related.humanname.given
                if practitioner_related.family:
                    model_practitioner.family = practitioner_related.humanname.family
